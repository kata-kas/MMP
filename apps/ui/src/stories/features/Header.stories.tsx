...
export const WithDescription: Story = {
	args: {
		title: "Project Title",
		description:
			"This is a detailed description of the project. It can contain <strong>HTML</strong> and multiple lines of text.",
	},
};
...
export const WithImage: Story = {
	args: {
		...
		imagePath:
			"https://images.unsplash.com/photo-1563520239648-a24e51d4b570?q=80&w=2000&h=400&auto=format&fit=crop",
	},
};
...
export const Complete: Story = {
	args: {
		...
		description:
			"A comprehensive project description with <em>formatting</em> and <strong>emphasis</strong>.",
		imagePath:
			"https://images.unsplash.com/photo-1563520239648-a24e51d4b570?q=80&w=2000&h=400&auto=format&fit=crop",
