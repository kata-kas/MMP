...
import { mockAssets, mockProjects } from "../mocks/mockData";
...
const mockProjectAssets = mockAssets.filter(
	(a) => a.project_uuid === mockProject.uuid,
);
...
export const EmptyState: Story = {
	render: () => (
		<div className="min-h-screen bg-background">
			<Header
				title="Empty Project"
				description="This project has no assets yet"
			/>
			<div className="container mx-auto w-full my-2">
				<Tabs defaultValue="all">
					<TabsList>
