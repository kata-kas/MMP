...
const SidebarEdgeTrigger = React.forwardRef<
	HTMLButtonElement,
	React.ComponentProps<"button"> & {
		side?: "left" | "right";
	}
>(({ className, side = "left", onClick, ...props }, ref) => {
	...
	return (
		<button
			...
			className={cn(
				"absolute top-1/2 z-30 hidden h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full border border-sidebar-border bg-sidebar text-sidebar-foreground/70 shadow-sm transition-[transform,background-color,color,border-color] duration-200 ease-linear hover:bg-sidebar-accent hover:text-sidebar-accent-foreground md:flex",
...
SidebarEdgeTrigger.displayName = "SidebarEdgeTrigger";
