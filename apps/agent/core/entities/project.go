...
// Deprecated: Project entity is deprecated in favor of unified Asset model
type Project struct {
	...
	Assets         map[string]interface{} `json:"-" toml:"-" form:"assets" query:"assets" gorm:"-"` // Deprecated: use Asset model
